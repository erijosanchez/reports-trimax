...
class CajaChicaSubmitida extends Notification
{
    ...
    public function __construct(
        public ReporteCajaChica $reporte,
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        $subject = "💰 {$accion} Reporte de Caja Chica — Sede {$this->reporte->sede} | Semana {$this->reporte->semana_numero}/{$this->reporte->anio}";

        $mail = (new MailMessage)
            ->subject($subject)
            ->view('emails.productividad.caja_chica_submitida', [
