...
class Voucher extends Model
{
     ...
     * comportamiento por defecto, no como comprobación manual en cada
     * controlador. Para saltárselo a propósito (finanzas ve todas las
     * sedes): Voucher::withoutGlobalScope(SedeScope::class).
     */
