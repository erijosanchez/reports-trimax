...
/**
 * Se ejecuta semanalmente el domingo 02:00 AM (Lima), un par de horas
 * después del límite del sábado 11:59 PM. Crea registros "no_enviado" para
 * las sedes que no enviaron su reporte de Caja Chica esa semana — mismo
 * patrón que MarcarNoEnviadosCobranzaJob, adaptado a la cadencia semanal de
 * este módulo (Cobranza es diaria).
 *
 * datosSemanActual() ya corre el límite al siguiente día hábil si el sábado
 ...
 * primera versión.
 */
class MarcarNoEnviadosCajaChicaJob implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    public function handle(): void
    {
        [$semanaNumero, $anio, $inicio, $fin, $limite] = ReporteCajaChica::datosSemanActual();
        ...
        foreach ($usuariosPorSede as $usuario) {
            ...
            $existe = ReporteCajaChica::where('sede', $sede)
