...
/**
 * Ejecuta cada jueves a las 7:00 PM (Lima) — dentro del horario laboral, 5h antes del límite (11:59 PM).
...
class AlertaComentariosVencimientoJob implements ShouldQueue
{
    ...
    {
        // Jueves feriado: el plazo ya corrió al siguiente día hábil, no se notifica hoy.
