...
<?php $__env->startSection('title', 'Lead Time'); ?>
...
$(document).ready(() => {
    ...
    $.ajax({
        url: "<?php echo route('comercial.lead-time.years'); ?>",
        method: 'GET',
...
function loadData() {
    ...
    $.ajax({
        url: "<?php echo route('comercial.lead-time.data'); ?>",
        method: 'GET',
        data: { year, month },
        timeout: 60000,
...
function clearCache() {
    $.ajax({
        url: "<?php echo route('comercial.lead-time.clear-cache'); ?>",
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/comercial/lead-time.blade.php ENDPATH**/ ?>