...
<?php $__env->startSection('alert_banner'); ?>
    <div class="email-alert <?php echo $esEdicion ? 'email-alert--warning' : 'email-alert--success'; ?>">
        ...
        <?php echo $esEdicion ? 'Se actualizó un reporte de cobranza' : 'Nuevo reporte de cobranza recibido'; ?>
...
<?php $__env->startSection('body'); ?>
    ...
    <p class="email-intro">
        <?php if($esEdicion): ?>
            Se ha <strong>editado</strong> el reporte de cobranza de la sede <strong><?php echo $reporte->sede; ?></strong>.
            ...
            <?php endif; ?>
        <?php else: ?>
            Se ha recibido el <strong>reporte semanal de cobranza</strong> de la sede <strong><?php echo $reporte->sede; ?></strong>.
        <?php endif; ?>
    </p>
        ...
        <div class="data-card__body">
            ...
            <div class="data-row">
                ...
                <div class="data-value">
                    <?php echo $reporte->semana_inicio?->format('d/m/Y'); ?> — <?php echo $reporte->semana_fin?->format('d/m/Y'); ?>
            ...
            <div class="data-row">
                ...
                <div class="data-value">
                    <span style="font-weight:700;font-size:16px;color:<?php echo $reporte->kpi_porcentaje >= 100 ? '#059669' : ($reporte->kpi_porcentaje >= 50 ? '#d97706' : '#dc2626'); ?>">
...
<?php echo $__env->make('emails.layouts.productividad', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/emails/productividad/cobranza_submitida.blade.php ENDPATH**/ ?>