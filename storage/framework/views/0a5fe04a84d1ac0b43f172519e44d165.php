...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('assets/css/survey.css'); ?>">
    <link rel="icon" type="image/x-icon" href="<?php echo asset('assets/img/fv.png'); ?>">
</head>
        ...
        <div id="survey-container" style="display: none;">
            ...
            <form id="survey-form">
                ...
                <div class="trimax-logo">
                    <img src="<?php echo asset('assets/img/ltr.png'); ?>" alt="">
                </div>
            </form>
        </div>
...
<?php /**PATH /var/www/resources/views/marketing/survey/form.blade.php ENDPATH**/ ?>