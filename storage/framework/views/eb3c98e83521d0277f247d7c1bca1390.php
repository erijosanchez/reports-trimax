                                                                        ...
                                                                        <div class="form-check form-check-success">
                                                                            <label class="form-check-label">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    value="1"
                                                                                    class="form-check-input"
                                                                                    <?php echo old('puede_ver_motorizados', $user->puede_ver_motorizados ?? false) ? 'checked' : ''; ?>>
                                ...
                                <div class="grid-margin col-lg-4 stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <?php if($permisosTracking->isNotEmpty()): ?>
                                                <div class="mb-3 pb-3 border-bottom">
                                                    <p class="mb-2 text-muted"><small><i
                                                                class="me-1 mdi mdi-map-marker-path"></i>Permisos
                                                            Tracking</small></p>
                                                    <div class="d-flex flex-wrap gap-1">
                                                        <?php $__currentLoopData = $permisosTracking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
