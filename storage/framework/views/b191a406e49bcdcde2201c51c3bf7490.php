<?php $__env->startSection('title', 'Órdenes de Entrega'); ?>
                            ...
                            <div class="col-md-3 col-sm-6">
                                ...
                                <select id="filtro-sede" class="form-select form-select-sm">
                                    ...
                                    <?php $__currentLoopData = $sedes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo $s; ?>" <?php echo request('sede') === $s ? 'selected' : ''; ?>><?php echo $s; ?></option>
                ...
                <div class="h-100 card card-stat shadow-sm border-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <p class="mb-1 text-muted"><?php echo $s['label']; ?></p>
                                <h2 class="mb-0 font-weight-bold text-<?php echo $s['color']; ?>"><?php echo $s['val']; ?></h2>
                            </div>
                            <div class="bg-<?php echo $s['color']; ?> icon-stat">
                ...
                <div class="shadow-sm border-0 card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $ordenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-muted small"><?php echo $o->id; ?></td>
                                        <td>
                                            <div class="fw-semibold small"><?php echo $o->cliente_nombre; ?></div>
                                            <?php if($o->cliente_telefono): ?>
                                                <div class="text-muted" style="font-size:11px">
                                                    <i class="mdi mdi-phone"></i> <?php echo $o->cliente_telefono; ?>

                                                </div>
                                            <?php endif; ?>
                                        </td>
                                        <td class="small text-muted"><?php echo $o->referencia ?? '—'; ?></td>
                                        <td class="small" style="max-width:200px"><?php echo $o->direccion; ?></td>
                                        <td><span class="badge bg-secondary"><?php echo $o->sede; ?></span></td>
                                        <td>
                                            <?php
                                                $badgeMap = ['pendiente'=>'bg-secondary','en_ruta'=>'bg-warning text-dark','entregado'=>'bg-success','fallido'=>'bg-danger'];
                                            ?>
                                            <span class="badge <?php echo $badgeMap[$o->estado] ?? 'bg-secondary'; ?>">
                                                <?php echo ucfirst(str_replace('_',' ',$o->estado)); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <?php if($o->latitud && $o->longitud): ?>
                                                <a href="https://maps.google.com/?q=<?php echo $o->latitud; ?>,<?php echo $o->longitud; ?>"
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-outline-warning btn-editar-orden"
                                                data-orden="<?php echo json_encode($o); ?>" title="Editar">
                                                <i class="mdi mdi-pencil"></i>
                                            </button>
                                            <button class="btn btn-sm btn-outline-danger btn-eliminar-orden"
                                                data-id="<?php echo $o->id; ?>" title="Eliminar">
                        ...
                        <?php if($ordenes->hasPages()): ?>
                            <div class="mt-3"><?php echo $ordenes->links(); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <form id="form-crear-orden">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo $__env->make('tracking._form-orden', ['sedes' => $sedes], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <form id="form-editar-orden">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo $__env->make('tracking._form-orden', ['sedes' => $sedes, 'prefix' => 'edit-'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/tracking/ordenes.blade.php ENDPATH**/ ?>