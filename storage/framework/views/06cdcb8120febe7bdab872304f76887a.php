            ...
            <div class="grid-margin col-lg-12 stretch-card">
                <div class="card">
                    <div class="d-flex align-items-center justify-content-between px-4 py-3 card-body">
                        ...
                        <a href="<?php echo route('tracking.mapa'); ?>" class="btn btn-sm btn-outline-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/tracking/historial.blade.php ENDPATH**/ ?>