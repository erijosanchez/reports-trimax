                                ...
                                <div class="col-lg-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="<?php echo route('files.upload'); ?>"
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-description">
                                                Total de archivos: <code><?php echo $files->total(); ?></code>
                                            </p>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div>
                                                                                <span
                                                                                    class="fw-bold"><?php echo $file->original_name; ?></span>
                                                                                <?php if($file->description): ?>
                                                                                    <br><small
                                                                                        class="text-muted"><?php echo $file->description; ?></small>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <span
                                                                            class="badge badge-outline-primary"><?php echo strtoupper($file->file_type); ?></span>
                                                                    </td>
                                                                    <td>
                                                                        <span
                                                                            class="text-muted"><?php echo $file->file_size_formatted; ?></span>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <img class="img-xs rounded-circle me-2"
                                                                                ...
                                                                                alt="profile">
                                                                            <span><?php echo $file->user->name; ?></span>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <span
                                                                            class="text-muted"><?php echo $file->created_at->format('d/m/Y'); ?></span><br>
                                                                        <small
                                                                            class="text-muted"><?php echo $file->created_at->format('H:i'); ?></small>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex gap-1">
                                                                            <a href="<?php echo route('files.view', $file->id); ?>"
                                                                            ...
                                                                            <?php if($file->user_id === auth()->id() || auth()->user()->isAdmin() || auth()->user()->isSuperAdmin()): ?>
                                                                                <form method="POST"
                                                                                    action="<?php echo route('files.destroy', $file->id); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/files/index.blade.php ENDPATH**/ ?>