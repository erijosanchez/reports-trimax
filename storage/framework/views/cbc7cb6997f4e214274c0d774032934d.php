                                        ...
                                        <div class="d-flex align-items-center flex-grow-1">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <?php if($dashboard->description): ?>
                                                    <p class="text-muted mt-1 mb-0"><?php echo $dashboard->description; ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body p-0">
                                            <div id="dashboard-container" class="powerbi-container">
                                                ...
                                                <iframe id="powerbi-iframe" src="<?php echo $powerbiLink; ?>" frameborder="0"
                                                    allowfullscreen>
                                                </iframe>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/dashboards/show.blade.php ENDPATH**/ ?>