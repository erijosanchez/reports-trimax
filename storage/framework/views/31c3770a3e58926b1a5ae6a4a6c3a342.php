...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 dark:text-gray-200"><?php echo Auth::user()->name; ?></div>
                <div class="font-medium text-sm text-gray-500"><?php echo Auth::user()->email; ?></div>
            </div>
