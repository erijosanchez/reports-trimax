                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <div>
                                            <a href="<?php echo route('marketing.users.index'); ?>"
                                ...
                                <div class="col-lg-8 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="<?php echo route('marketing.users.store'); ?>"
                                                id="createUserForm">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name"
                                                        class="form-control form-control-lg" value="<?php echo old('name'); ?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="role" id="role"
                                                        ...
                                                        <option value="consultor"
                                                            <?php echo old('role') == 'consultor' ? 'selected' : ''; ?>>
                                                            Consultor
                                                        </option>
                                                        <option value="sede"
                                                            <?php echo old('role') == 'sede' ? 'selected' : ''; ?>>
                                                            Sede
                                                        </option>
                                                        <option value="trimax"
                                                            <?php echo old('role') == 'trimax' ? 'selected' : ''; ?>>
                                                            Trimax
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group" id="locationField" style="display: none;">
                                                    ...
                                                    <input type="text" name="location"
                                                        class="form-control form-control-lg" value="<?php echo old('location'); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/marketing/users/create.blade.php ENDPATH**/ ?>