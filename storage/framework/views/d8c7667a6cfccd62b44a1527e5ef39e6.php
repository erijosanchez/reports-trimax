                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-3">
                                                ...
                                                Usuarios Online
                                                <span class="badge badge-success ms-2"><?php echo $usersOnline->count(); ?></span>
                                            </h4>
                                            ...
                                            <div style="max-height: 500px; overflow-y: auto;">
                                                ...
                                                <?php else: ?>
                                                    <?php $__currentLoopData = $usersOnline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $__currentLoopData = $user->activeSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="d-flex align-items-center border-bottom py-3">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <p class="mb-0 fw-bold"><?php echo $user->name; ?></p>
                                                                    <small class="text-muted">
                                                                        <i class="mdi mdi-clock-outline me-1"></i>
                                                                        <?php echo $session->last_activity->diffForHumans(); ?>

                                                                    </small>
                                                                </div>
                                                                <small class="text-muted">
                                                                    <?php echo $session->login_at->diffForHumans(null, true); ?>
