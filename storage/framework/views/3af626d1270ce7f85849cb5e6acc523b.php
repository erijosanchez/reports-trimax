<?php $__env->startSection('title', 'Logs de Actividad'); ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="<?php echo route('admin.dashboard'); ?>" class="btn btn-light btn-sm me-3">
                                            ...
                                            <form method="GET" id="filterForm">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <select name="action" class="form-select">
                                                            ...
                                                            <option value="login"
                                                                <?php echo request('action') == 'login' ? 'selected' : ''; ?>>Login
                                                            </option>
                                                            <option value="logout"
                                                                <?php echo request('action') == 'logout' ? 'selected' : ''; ?>>Logout
                                                            </option>
                                                            <option value="create"
                                                                <?php echo request('action') == 'create' ? 'selected' : ''; ?>>Crear
                                                            </option>
                                                            <option value="update"
                                                                <?php echo request('action') == 'update' ? 'selected' : ''; ?>>
                                                                Actualizar</option>
                                                            <option value="delete"
                                                                <?php echo request('action') == 'delete' ? 'selected' : ''; ?>>
                                                                Eliminar</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <input type="date" name="date_from"
                                                            value="<?php echo request('date_from'); ?>" class="form-control">
                                                    </div>

                                                    <div class="col-md-3 mb-3">
                                                        <label class="form-label">Fecha Hasta</label>
                                                        <input type="date" name="date_to"
                                                            value="<?php echo request('date_to'); ?>" class="form-control">
                                                    </div>

                                                    <div class="col-md-9 mb-3">
                                                        <label class="form-label">Buscar en descripción o IP</label>
                                                        <input type="text" name="search"
                                                            value="<?php echo request('search'); ?>" class="form-control"
                                                ...
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <span class="text-muted ms-3 align-self-center">
                                                        ...
                                                        Mostrando <?php echo $logs->count(); ?> de <?php echo $logs->total(); ?> registros
                                                    </span>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="card-body py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <strong><?php echo $logs->total(); ?></strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    <td>
                                                                        <div>
                                                                            <span
                                                                                class="text-muted"><?php echo $log->created_at->format('d/m/Y'); ?></span><br>
                                                                            <small
                                                                                class="text-muted"><?php echo $log->created_at->format('H:i:s'); ?></small>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div>
                                                                                <span
                                                                                    class="fw-bold"><?php echo $log->user->name; ?></span><br>
                                                                                <small
                                                                                    class="text-muted"><?php echo $log->user->email; ?></small>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div class="text-muted description-cell">
                                                                            <span
                                                                                class="description-text"><?php echo Str::limit($log->description, 60); ?></span>
                                                                            <?php if(strlen($log->description) > 60): ?>
                                                                                <a href="#"
                                                                                    class="view-full d-block mt-1"
                                                                                    data-description="<?php echo $log->description; ?>">
                                                                                    <small>Ver más</small>
                                                                                </a>
                                                                            <?php endif; ?>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <code
                                                                            class="text-dark"><?php echo $log->ip_address; ?></code>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </tbody>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/activity-logs.blade.php ENDPATH**/ ?>