...
<?php $__env->startSection('title', 'Pendiente - Entrega Montura'); ?>
                        ...
                        <div class="tab-pane fade show active" id="overview" role="tabpanel">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="d-flex align-items-center justify-content-end gap-2 col-lg-4">
                                    <span class="me-2 text-muted small" style="display: none">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="bg-white me-3 rounded icon-wrapper">
                                                    <i class="text-primary mdi mdi-clock-alert mdi-36px"></i>
                                                </div>
                                                <div>
        ...
        (function() {
            ...
            function cargarDatos(limpiarCache) {
                ...
                const doLoad = function() {
                    ...
                    fetch(
                            `<?php echo route('produccion.api.pendiente-montura.data'); ?>?sede=${encodeURIComponent(sede)}&rango=${encodeURIComponent(rango)}`)
                        .then(function(r) {
                            return r.json();
                        })
                        .then(function(res) {
                ...
                if (limpiarCache) {
                    fetch('<?php echo route('produccion.api.pendiente-montura.clear-cache'); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/comercial/pendiente-entrega-montura.blade.php ENDPATH**/ ?>