        ...
        (function() {
            ...
            function cargarDatos(limpiarCache) {
                ...
                const doLoad = function() {
                    ...
                    fetch(
                            `<?php echo route('comercial.api.pendiente-montura.data'); ?>?sede=${encodeURIComponent(sede)}&rango=${encodeURIComponent(rango)}`)
                        .then(function(r) {
                            return r.json();
                        })
                        .then(function(res) {
                ...
                if (limpiarCache) {
                    fetch('<?php echo route('comercial.api.pendiente-montura.clear-cache'); ?>', {
                        method: 'POST',
                        headers: {
