...
<?php $__env->startSection('scripts'); ?>
    ...
    <div class="kw-table-card">
        ...
        function kwRenderTrendChart() {
            ...
            // Usar datos diarios del mes seleccionado
            const dias = d.dias ?? [];
            ...
            // Nuevos arrays para el tooltip — vienen del backend
            const dayOrders = d.dayOrders ?? []; // ordenes entregadas ese dia (TIME)
            const dayVencidos = d.dayVencidos ?? []; // ordenes vencidas ese dia (LEAD_TIME sin entrega a tiempo)
            ...
            // Lineas de referencia 95% y 89.9%
            const refPlugin = {
                id: 'refLines',
                afterDraw(chart) {
                    const {
