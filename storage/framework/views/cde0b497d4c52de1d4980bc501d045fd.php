<?php $__env->startSection('title', 'Mi Firma Digital'); ?>
            ...
            <div class="col-lg-7">
                ...
                <?php if($errors->any()): ?>
                    <div class="alert alert-danger alert-dismissible fade show">
                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><div><?php echo $error; ?></div><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    </div>
                <?php endif; ?>

                
                <?php if($usuario->tieneFirmaRegistrada()): ?>
                    <div class="shadow-sm mb-4 card">
                        <div class="card-body">
                            ...
                            <div class="border rounded p-3 bg-light text-center" style="min-height:90px;">
                                <img src="<?php echo $usuario->firma_imagen; ?>" alt="Mi firma" style="max-height:80px; max-width:300px;">
                            </div>
                            <form method="POST" action="<?php echo route('firma.destroy'); ?>" class="mt-3 d-inline"
                ...
                <div class="shadow-sm card">
                    <div class="card-body">
                        <h6 class="mb-3 text-primary">
                            ...
                            <?php echo $usuario->tieneFirmaRegistrada() ? 'Reemplazar firma' : 'Registrar firma'; ?>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="tabDibujar">
                                ...
                                <form method="POST" action="<?php echo route('firma.store'); ?>" id="formDibujar">
                                    <?php echo csrf_field(); ?>
                            ...
                            <div class="tab-pane fade" id="tabSubir">
                                ...
                                <form method="POST" action="<?php echo route('firma.store'); ?>" id="formSubir">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/firma/index.blade.php ENDPATH**/ ?>