...
<table class="mt" style="border:none;">
    <tr>
        ...
        <td style="border:none; border-bottom:1pt solid #000; width:32%; text-align:right;">
            <span class="lbl">Fecha de Solicitud:</span> <?php echo $requerimiento->fecha_solicitud->format('d/m/Y'); ?>
...
<table class="mt">
    ...
    <tr>
        ...
        <td style="width:32%;"><?php echo $requerimiento->puesto; ?></td>
        <td class="lbl" style="width:10%;">Área:</td>
        <td style="width:40%;"><?php echo $requerimiento->gerencia; ?></td>
    </tr>
    <tr>
        <td class="lbl">Reporta a:</td>
        <td colspan="3"><?php echo $requerimiento->jefe_directo; ?></td>
    </tr>
    <tr>
        <td class="lbl">Supervisa a:</td>
        <td colspan="3"><?php echo $requerimiento->supervisa_a ?? ''; ?></td>
    </tr>
    <tr>
        <td class="lbl">N° de vacantes:</td>
        <td><?php echo $requerimiento->num_vacantes ?? 1; ?></td>
    ...
    <tr style="padding:0 !important; margin:0 !important;">
        ...
        <td style="width:50%; padding:0 !important; margin:0 !important; vertical-align:top;">
            <table style="border:none; padding:0 !important; margin:0 !important;">
                ...
                <tr>
                    <td style="border-left:none;"><span class="chk"><?php echo $requerimiento->tipo_vacante==='vacante'        ? 'X':'&nbsp;'; ?></span> Vacante</td>
                    <td style="border-right:none;"><span class="chk"><?php echo $requerimiento->permanencia==='temporal'       ? 'X':'&nbsp;'; ?></span> Temporal</td>
                </tr>
                <tr>
                    <td style="border-left:none;"><span class="chk"><?php echo $requerimiento->tipo_vacante==='reemplazo'      ? 'X':'&nbsp;'; ?></span> Reemplazo</td>
                    <td style="border-right:none;"><span class="chk"><?php echo $requerimiento->permanencia==='permanente'     ? 'X':'&nbsp;'; ?></span> Permanente</td>
                </tr>
                <tr>
                    <td style="border-left:none;"><span class="chk"><?php echo $requerimiento->tipo_vacante==='posicion_nueva' ? 'X':'&nbsp;'; ?></span> Posición nueva</td>
                    <td style="border-right:none;"><span class="chk"><?php echo $requerimiento->disponibilidad_viaje           ? 'X':'&nbsp;'; ?></span> Disponibilidad para viajar</td>
                </tr>
                <tr>
                    <td style="border-left:none;"><span class="chk"><?php echo $requerimiento->jornada==='tiempo_parcial'     ? 'X':'&nbsp;'; ?></span> Tiempo Parcial</td>
                    <td style="border-right:none;"><span class="chk"><?php echo $requerimiento->jornada==='tiempo_completo'   ? 'X':'&nbsp;'; ?></span> Tiempo Completo</td>
                </tr>
                <tr>
                    <td colspan="2" style="border-left:none; border-right:none; border-bottom:none; height:30pt; vertical-align:top;">
                        <span class="lbl">Motivo:</span> <?php echo $requerimiento->motivo ?? ''; ?>
        ...
        <td style="width:50%; padding:0; vertical-align:top;">
            <table style="border:none; padding:0 !important; margin:0 !important;">
                ...
                <tr>
                    ...
                    <td style="border-right:none;"><?php echo $requerimiento->fecha_estimada_contratacion ? $requerimiento->fecha_estimada_contratacion->format('d/m/Y') : ''; ?></td>
                </tr>
                <tr>
                    <td class="lbl" style="border-right:none;">Tipo de contrato:</td>
                    <td style="border-right:none;"><?php echo $requerimiento->tipo_contrato ?? ''; ?></td>
                </tr>
                <tr>
                    <td class="lbl" style="border-right:none;">Duración:</td>
                    <td style="border-right:none;"><?php echo $requerimiento->duracion_contrato ?? ''; ?></td>
                </tr>
                <tr>
                    <td class="lbl" style="border-right:none;">Remuneración prevista S/.</td>
                    <td style="border-right:none;"><?php echo $requerimiento->remuneracion_prevista ? number_format($requerimiento->remuneracion_prevista, 2) : ''; ?></td>
                </tr>
                <tr>
                    <td class="lbl" style="border-right:none;">Horario de Trabajo:</td>
                    <td style="border-right:none;"><?php echo $requerimiento->horario_trabajo ?? ''; ?></td>
                </tr>
                <tr>
                    <td class="lbl" style="border-right:none; border-bottom:none;">Beneficios:</td>
                    <td style="border-right:none; border-bottom:none;"><?php echo $requerimiento->beneficios ?? ''; ?></td>
                </tr>
            </table>
        </td>
    </tr>
...
<table class="mt">
    ...
    <tr>
        <td><?php echo $l; ?>. <?php echo $cands[$i]['nombre'] ?? ''; ?></td>
        <td><?php echo $cands[$i]['telefono'] ?? ''; ?></td>
    </tr>
...
<table class="mt">
    ...
    <?php $__currentLoopData = ['a','b','c']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr><td style="height:15pt;"><?php echo $l; ?>. <?php echo $herrs[$i] ?? ''; ?></td></tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
    ...
    <tr>
        ...
        <td class="firma-box">
            <?php if($requerimiento->firma_solicitante_data): ?>
                <div class="firma-img-wrap">
                    <img src="<?php echo $requerimiento->firma_solicitante_data; ?>" style="max-height:46pt; max-width:120pt;">
                </div>
            <?php else: ?>
            ...
            <?php if($requerimiento->firma_solicitante_nombre): ?>
                <div class="firma-nom"><?php echo $requerimiento->firma_solicitante_nombre; ?></div>
            <?php endif; ?>
            <?php if($requerimiento->firma_solicitante_at): ?>
                <div class="firma-fec"><?php echo $requerimiento->firma_solicitante_at->format('d/m/Y H:i'); ?></div>
            <?php endif; ?>
        </td>
        ...
        <td class="firma-box">
            <?php if($requerimiento->firma_rrhh_data): ?>
                <div class="firma-img-wrap">
                    <img src="<?php echo $requerimiento->firma_rrhh_data; ?>" style="max-height:46pt; max-width:120pt;">
                </div>
            <?php else: ?>
                <div style="height:50pt;"></div>
            <?php endif; ?>
            ...
            <?php if($requerimiento->firma_rrhh_nombre): ?>
                <div class="firma-nom"><?php echo $requerimiento->firma_rrhh_nombre; ?></div>
            <?php endif; ?>
            <?php if($requerimiento->firma_rrhh_at): ?>
                <div class="firma-fec"><?php echo $requerimiento->firma_rrhh_at->format('d/m/Y H:i'); ?></div>
            <?php endif; ?>
        </td>
        ...
        <td class="firma-box">
            <?php if($requerimiento->firma_gerente_data): ?>
                <div class="firma-img-wrap">
                    <img src="<?php echo $requerimiento->firma_gerente_data; ?>" style="max-height:46pt; max-width:120pt;">
                </div>
            <?php else: ?>
                <div style="height:50pt;"></div>
            <?php endif; ?>
            ...
            <?php if($requerimiento->firma_gerente_nombre): ?>
                <div class="firma-nom"><?php echo $requerimiento->firma_gerente_nombre; ?></div>
            <?php endif; ?>
            <?php if($requerimiento->firma_gerente_at): ?>
                <div class="firma-fec"><?php echo $requerimiento->firma_gerente_at->format('d/m/Y H:i'); ?></div>
            <?php endif; ?>
        </td>
    </tr>
</table>
