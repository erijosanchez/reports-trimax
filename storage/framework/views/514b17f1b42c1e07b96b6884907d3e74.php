                ...
                <div class="card">
                    <div class="d-flex align-items-center justify-content-between px-4 py-3 card-body">
                        <div>
                            ...
                            <p class="mb-0 text-muted small">Reporte semanal — límite: sábado 2:00 PM</p>
                        </div>
                        <div class="text-end">
    ...
    <div class="page-content">
            ...
            <div class="mb-3 col-lg-4 col-md-6">
                <div class="shadow-sm border-0 h-100 card" id="card-countdown">
                    <div class="py-4 text-center card-body">
                        ...
                        <hr class="my-3">
                        <div class="text-muted small">Límite: <strong>Sábado 2:00 PM</strong></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="py-4 card-body">
                        ...
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex align-items-center justify-content-between p-3 rounded"
                                ...
                                <div>
                                    <div class="text-success fw-bold">Enviado el sábado</div>
                                    <div class="text-muted small">Cualquier hora del sábado</div>
                                </div>
                                <span class="bg-success badge fs-5">100%</span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between p-3 rounded"
                                 style="background:#fee2e2;border-left:4px solid #ef4444;">
                                <div>
                                    <div class="text-danger fw-bold">Otro día</div>
                                    <div class="text-muted small">Antes o después del sábado</div>
                                </div>
                                <span class="bg-danger badge fs-5">0%</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mb-4 row">
            <div class="col-12">
                <div class="shadow-sm border-0 card">
                    <div class="d-flex align-items-center justify-content-between bg-white border-bottom card-header">
                        <h5 class="mb-0 fw-bold"><i class="me-2 text-success mdi mdi-chart-line"></i>KPI por Sede</h5>
...
function renderPreview(files, preview, input) {
    ...
    for (let i = 0; i < files.length; i++) {
        ...
        col.innerHTML = `<div class="p-1 preview-thumb">${isImg ? `<img src="${URL.createObjectURL(f)}" alt="">` : `<div class="d-flex align-items-center justify-content-center" style="height:80px;font-size:2rem;"><i class="text-success mdi mdi-file-excel"></i></div>`}<button type="button" class="preview-remove" onclick="quitarArchivo(${i},this)">×</button><div class="text-muted preview-name">${f.name}</div></div>`;
