...
<div
    ...
    x-init="
        highlightedCode = window.highlight(
            <?php echo Illuminate\Support\Js::from($code); ?>,
            <?php echo Illuminate\Support\Js::from($language); ?>,
            <?php echo Illuminate\Support\Js::from($truncate); ?>,
            <?php echo Illuminate\Support\Js::from($editor); ?>,
            <?php echo Illuminate\Support\Js::from($startingLine); ?>,
            <?php echo Illuminate\Support\Js::from($highlightedLine); ?>
