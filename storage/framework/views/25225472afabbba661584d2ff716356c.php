<?php $__env->startSection('title', 'Editar Dashboard'); ?>
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-custom mb-2" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="users-tab" data-bs-toggle="tab" href="#users"
                                                ...
                                                Asignar Usuarios
                                                <span
                                                    class="badge badge-primary ms-2"><?php echo $dashboard->users->count(); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="col-lg-12 mx-auto grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form method="POST"
                                                        action="<?php echo route('dashboards.update', $dashboard->id); ?>">
                                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                                    value="<?php echo old('name', $dashboard->name); ?>" required
...
unset($__errorArgs, $__bag); ?>" rows="3"
                                                                    placeholder="Breve descripción del dashboard..."><?php echo old('description', $dashboard->description); ?></textarea>
                                                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                                                    value="<?php echo old('powerbi_link', $dashboard->decrypted_link); ?>"
                                                                    required
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-check form-check-success">
                                                                <label class="form-check-label">
                                                                    <input type="checkbox" name="is_active" value="1"
                                                                        ...
                                                                        <?php echo old('is_active', $dashboard->is_active) ? 'checked' : ''; ?>>
                                                                    Dashboard activo
                                                        ...
                                                        <div class="d-flex gap-2 justify-content-between pt-3 border-top">
                                                            <a href="<?php echo route('dashboards.index'); ?>"
                                                                class="btn btn-light">
                                                        ...
                                                        <div class="mt-5 pt-4 border-top">
                                                            <div class="alert alert-danger d-flex align-items-start"
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <form method="POST"
                                                                        action="<?php echo route('dashboards.destroy', $dashboard->id); ?>"
                                        ...
                                        <div class="col-lg-10 mx-auto grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form method="POST"
                                                        action="<?php echo route('dashboards.assign-users', $dashboard->id); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="alert alert-light border d-flex align-items-center mb-3"
                                                            ...
                                                            <div class="ms-3">
                                                                <span class="badge badge-primary"
                                                                    id="selected-count"><?php echo count($assignedUserIds); ?></span>
                                                                        ...
                                                                        <label class="form-check-label w-100">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                    ...
                                                                                    <small
                                                                                        class="text-muted"><?php echo $user->email; ?></small>
                                                                                </div>

                                                                                <div>
                                                                                    <?php $__currentLoopData = $user->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <span
                                                                                            class="badge badge-info"><?php echo $role->name; ?></span>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <strong>Total de usuarios seleccionados: <span
                                                                            id="selected-count-bottom"><?php echo count($assignedUserIds); ?></span></strong>
                                                                    <p class="mb-0 mt-1">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/dashboards/edit.blade.php ENDPATH**/ ?>