...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('assets/css/login.css'); ?>?v=<?php echo filemtime(public_path('assets/css/login.css')); ?>">
    <link rel="shortcut icon" href="<?php echo asset('assets/img/fv.png'); ?>" type="image/x-icon">
</head>
    ...
    <div class="login-wrapper">
        ...
        <div class="panel-brand">
            ...
            <div class="brand-content">
                <img src="<?php echo asset('assets/img/logoblanco.png'); ?>"
        ...
        <div class="panel-form">
            <div class="form-card">
                ...
                <div class="alert-error">
                    ...
                    <span><?php echo $errors->first(); ?></span>
                </div>
                <?php endif; ?>

                <form method="POST" action="<?php echo route('login'); ?>" id="loginForm" novalidate>
                    <?php echo csrf_field(); ?>
                ...
                <p class="form-footer">
                    &copy; <?php echo date('Y'); ?> Laboratorio Trimax Óptico &middot; Todos los derechos reservados
                </p>
            </div>
        </div>
