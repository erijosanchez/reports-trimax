    ...
    <div class="login-container">
        ...
        <div class="brand-panel">
            <div class="logo-wrapper">
                <img src="<?php echo asset('assets/img/logoblanco.png'); ?>" alt="Laboratorio Trimax Óptico">
        ...
        <div class="form-panel">
            ...
            <?php if($errors->any()): ?>
                <div class="error-message">
                    <strong>Error:</strong> <?php echo $errors->first(); ?>

                </div>
            <?php endif; ?>

            <form method="POST" action="<?php echo route('login'); ?>" id="loginForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-footer">
                    <p>&copy; <?php echo date('Y'); ?> Laboratorio Trimax Óptico. Todos los derechos reservados.</p>
                </div>
            </form>
        </div>
    </div>
