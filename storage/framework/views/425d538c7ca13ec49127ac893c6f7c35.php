<?php $__env->startSection('title', 'Dashboard de Ventas'); ?>
...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="mb-4 row">
                                <div class="col-lg-8">
                                    ...
                                    <p class="mb-0 text-muted">
                                        ...
                                        <strong><?php echo $sedeUsuario; ?></strong>
                                    </p>
                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 text-white fw-bold" id="ventaGeneral">
                                                        S/ <?php echo number_format($datos['venta_general'], 0, '.', ','); ?>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 text-white fw-bold" id="ventaTotal">
                                                        S/ <?php echo number_format($datos['venta_proyectada'], 0, '.', ','); ?>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 text-white fw-bold" id="cuota">
                                                        S/ <?php echo number_format($datos['cuota'], 0, '.', ','); ?>
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 text-white fw-bold" id="cumplimiento">
                                                        <?php echo number_format($datos['cumplimiento_cuota'], 2); ?>%
                                                    </h4>
                                                </div>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="bg-success progress-bar" id="progressCumplimiento"
                                                    style="width: <?php echo min($datos['cumplimiento_cuota'], 100); ?>%">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h4 class="mb-0 text-white fw-bold" id="ventaDigital">
                                                            S/ <?php echo number_format($datos['venta_digital'], 0, '.', ','); ?>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h4 class="mb-0 text-white fw-bold" id="ventaProyDigital">
                                                            S/
                                                            <?php echo number_format($datos['venta_proy_digital'], 0, '.', ','); ?>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h4 class="mb-0 text-white fw-bold" id="cuotaDigital">
                                                            S/ <?php echo number_format($datos['cuota_digital'], 0, '.', ','); ?>
                                                ...
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h4 class="mb-0 text-white fw-bold" id="cumCuotaDigital">
                                                            <?php echo number_format($datos['cum_cuota_digital'], 2); ?>%
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div class="progress" style="height: 8px;">
                                                    <div class="bg-success progress-bar" id="progressCumDigital"
                                                        style="width: <?php echo min($datos['cum_cuota_digital'], 100); ?>%">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mb-4 card-title">
                                                ...
                                                Ventas vs Cuota - <span id="anioGrafico"><?php echo $anioActual; ?></span>
                                            </h4>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mb-4 card-title">
                                                ...
                                                Comparación de <?php echo $datosAnuales['mes'] ?? 'Mes Actual'; ?> - Histórico de
                                                Años
                                            </h4>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mb-4 card-title">
                                                ...
                                                Resumen Mensual - <span id="anioTabla"><?php echo $anioActual; ?></span>
                                            </h4>
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody id="tablaBody">
                                                        <?php $__empty_1 = true; $__currentLoopData = $historico['meses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $mes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                <td class="fw-semibold"><?php echo $mes; ?></td>
                                                                <td>S/
                                                                    <?php echo number_format($historico['ventas'][$index], 0, '.', ','); ?>

                                                                </td>
                                                                <td>S/
                                                                    <?php echo number_format($historico['cuotas'][$index], 0, '.', ','); ?>

                                                                </td>
                                                                <td
                                                                    class="fw-bold
                                                                    <?php if($historico['cumplimientos'][$index] >= 100): ?> text-success
                                                                    <?php elseif($historico['cumplimientos'][$index] >= 70): ?> text-warning
                                                                    <?php else: ?> text-danger <?php endif; ?>">
                                                                    <?php echo number_format($historico['cumplimientos'][$index], 2); ?>%
                                                                </td>
                                                                <td class="text-center">
                                                                    <?php if($historico['cumplimientos'][$index] >= 100): ?>
                                                                        <span class="badge badge-success"><i
                                                                                class="me-1 mdi mdi-check-circle"></i>Cumplido</span>
                                                                    <?php elseif($historico['cumplimientos'][$index] >= 70): ?>
    ...
    <script>
        ...
        let historico = {
            ...
            ventas: <?php echo json_encode($historico['ventas'], 15, 512) ?>,
            cuotas: <?php echo json_encode($historico['cuotas'], 15, 512) ?>,
            cumplimientos: <?php echo json_encode($historico['cumplimientos'], 15, 512) ?>
        };
        ...
        async function actualizarDatos() {
            ...
            try {
                const response = await fetch(`<?php echo route('api.ventas.data'); ?>?anio=${anio}&mes=${mes}`);
        ...
        function inicializarGraficos() {
            ...
            ventasAnualesChart = new Chart(ctxAnuales, {
                type: 'line',
                data: {
                    labels: <?php echo json_encode($datosAnuales['anios'], 15, 512) ?>,
                    datasets: [{
                        label: 'Ventas en <?php echo $datosAnuales['mes'] ?? 'Mes Actual'; ?>',
                        data: <?php echo json_encode($datosAnuales['ventas'], 15, 512) ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/home-ventas.blade.php ENDPATH**/ ?>