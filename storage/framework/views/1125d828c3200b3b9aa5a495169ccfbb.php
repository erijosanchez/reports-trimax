                                ...
                                <div class="col-sm-12">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div>
                                            ...
                                            <p class="text-muted mt-1">Modifica la información de <?php echo $user->name; ?></p>
                                        </div>
                                        <div>
                                ...
                                <div class="col-lg-8 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="<?php echo route('marketing.users.update', $user->id); ?>"
                                                id="editUserForm">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="role" id="role"
                                                                ...
                                                                <option value="consultor"
                                                                    <?php echo old('role', $user->role) == 'consultor' ? 'selected' : ''; ?>>
                                                                    Consultor
                                                                </option>
                                                                <option value="sede"
                                                                    <?php echo old('role', $user->role) == 'sede' ? 'selected' : ''; ?>>
                                                                    Sede
                                                                </option>
                                                                <option value="trimax"
                                                                    <?php echo old('role', $user->role) == 'trimax' ? 'selected' : ''; ?>>
                                                                    Trimax
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="locationField"
                                                            style="<?php echo old('role', $user->role) == 'sede' ? '' : 'display: none;'; ?>">
                                                            <label class="form-label">
                                                            ...
                                                            <input type="text" name="location"
                                                                class="form-control form-control-lg"
                                                                value="<?php echo old('location', $user->location); ?>"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                                <img class="img-md rounded-circle me-3"
                                                    src="https://ui-avatars.com/api/?name=<?php echo urlencode($user->name); ?>&background=6366f1&color=fff&size=128"
                                                    alt="profile">
                                                <div>
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <div>
                                                    ...
                                                    <small><?php echo $user->created_at->format('d/m/Y H:i'); ?></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/marketing/users/edit.blade.php ENDPATH**/ ?>