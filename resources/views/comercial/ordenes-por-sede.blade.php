...
@section('title', 'Órdenes por Sede')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnLimpiarCache').on('click', function() {
                ...
                $.post('{{ route('comercial.ordenes.cache') }}', {
                        _token: '{{ csrf_token() }}'
                    })
                    .always(function() {
            ...
            function cargarDatos(nocache) {
                ...
                const t0 = Date.now();
                $.getJSON('{{ route('comercial.ordenesPorSede.data') }}', params)
                    .done(function(res) {
