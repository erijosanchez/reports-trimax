                                    ...
                                    <div class="h-100 card card-stat">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="mb-1 text-muted">Total Acuerdos</p>
                                ...
                                <div class="pb-2 col-md-3">
                                    <div class="h-100 card card-stat">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="mb-1 text-muted">Vigentes</p>
            ...
            <div class="modal-content">
                ...
                <form id="formAcuerdo" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3 row">
                            <div class="col-md-12">
                                <h6 class="mb-3 text-primary"><i class="mdi mdi-calendar-range"></i> Vigencia y Detalles
                                </h6>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="btnGuardarAcuerdo">
                            <i class="mdi-content-save mdi"></i> Guardar Acuerdo
                        </button>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#btnExportarExcel').on('click', function() {
                ...
                const buscar  = $('#buscarGeneral').val();
        ...
        /**
         * Renderizar la página actual de acuerdosActuales
         */
            ...
            `;
                ...
                paginados.forEach((acuerdo, index) => {
                    ...
                    <tr ${esDeshabilitado ? 'class="table-secondary"' : ''}>
                        ...
                        <td><a href="#" onclick="verDetalles(${acuerdo.id}); return false;" title="Ver detalles" class="text-primary fw-bold text-decoration-none">${acuerdo.numero_acuerdo}</a></td>
                        <td>${badgeEstado}</td>
                        <td>
                            ${badgeValidado}
                            ...
                            ${canValidate && (acuerdo.validado === 'Aprobado' || acuerdo.validado === 'Rechazado') && !esDeshabilitado ? `
                                <button class="mt-1 btn-outline-info btn btn-sm" onclick="cambiarValidacion(${acuerdo.id})" title="Cambiar validación">
                        ...
                        <td>
                            ...
                            ${canApprove && (acuerdo.aprobado === 'Aprobado' || acuerdo.aprobado === 'Rechazado') && !esDeshabilitado ? `
                                <button class="mt-1 btn-outline-info btn btn-sm" onclick="cambiarAprobacion(${acuerdo.id})" title="Cambiar aprobación">
                                    <i class="mdi mdi-swap-horizontal"></i>
                                </button>
                            ` : ''}
                        </td>
