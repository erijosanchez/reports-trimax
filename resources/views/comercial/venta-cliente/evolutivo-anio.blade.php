{{-- resources/views/comercial/venta-cliente/evolutivo-anio.blade.php --}}
@extends('layouts.app')

@section('title', 'Venta Clientes Evolutivo - Año')
...
@section('content')
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mb-4 card-title">
                                            <i class="me-2 text-primary mdi mdi-chart-areaspline"></i>
                                            Venta Total por Año — Todos los Clientes
                                        </h4>
                                        <canvas id="chartAnual" height="90"></canvas>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        async function cargarDatos() {
            ...
            try {
                const res = await fetch('{{ route('comercial.venta-cliente.anio.data') }}');
