...
@section('others')
    ...
    <div class="page-header">
        <div class="breadcrumb">
            <span>Admin</span> / <a href="{{ route('admin.dashboards.index') }}">Dashboards</a> / Crear Nuevo
        </div>
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            <div>
                <h1>Crear Nuevo Dashboard</h1>
                <p>Agrega un nuevo reporte de Power BI al panel administrativo</p>
            </div>
                ...
                <form method="POST" action="{{ route('admin.dashboards.store') }}">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 15px;">
                        ...
                        <div>
                            ...
                            <input type="text" id="title" name="title" required placeholder="Ej. Reporte de Ventas"
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                placeholder="Describe brevemente el contenido del dashboard..."
                                style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 8px; font-size: 14px; margin-top: 5px; resize: vertical;"></textarea>
                        </div>

                        <div>
                            <label for="embed_url" style="font-weight: 600; color: #0a2540;">URL Embed de Power BI:</label>
                            <input type="url" id="embed_url" name="embed_url" required
                        ...
                        <div style="display: flex; gap: 20px; align-items: center;">
                            <div style="flex: 1;">
                                ...
                                <input type="number" id="order_position" name="order_position" value="0" required
                                    style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 8px; font-size: 14px; margin-top: 5px;">
                            </div>
