                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="{{ route('admin.users.update', $user->id) }}">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    @error('name')
                                                        <div class="mt-1 text-danger"><small>{{ $message }}</small></div>
                                                    @enderror
                                                </div>
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="pt-4 border-top">
                                                                        ...
                                                                        <div class="form-check form-check-success">
                                                                            <label class="form-check-label fw-semibold">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    value="1"
                                                                                    class="form-check-input"
                                                                                    {{ old('es_gerente_general', $user->es_gerente_general ?? false) ? 'checked' : '' }}>
                                                                                Es Gerente General
                                                                                <i class="input-helper"></i>
                                                                            </label>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-check form-check-success">
                                                                            <label class="form-check-label">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    value="1"
                                                                                    class="form-check-input"
                                                                                    {{ old('puede_ver_motorizados', $user->puede_ver_motorizados ?? false) ? 'checked' : '' }}>
                                                                                Ver Tracking Motorizados
                                                                                <i class="input-helper"></i>
                                                                            </label>
                                                                            <div><small class="text-muted">Mapa en vivo, órdenes, rutas y resumen diario</small></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="mt-3 mb-0 px-3 py-2 border alert alert-light">
                                                                    <small class="text-muted">
                                                                        ...
                                                                        Si el usuario tiene rol <strong>Sede</strong>, solo verá los motorizados y órdenes de su sede asignada.
                                                                    </small>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="ms-1 row g-2">
                                                                        ...
                                                                        <div class="form-check form-check-success">
                                                                            <label class="form-check-label">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    value="1"
                                                                                    class="form-check-input"
                                                                                    {{ old('puede_ver_retiros_ordenes', $user->puede_ver_retiros_ordenes ?? false) ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-check form-check-success">
                                                                            <label class="form-check-label">
                                                                                <input type="checkbox"
                                                                                    name="puede_ver_desbloqueo"
                                                                                    value="1"
                                                                                    class="form-check-input"
                                                                                    {{ old('puede_ver_desbloqueo', $user->puede_ver_desbloqueo ?? false) ? 'checked' : '' }}>
                                                                                Ver Desbloqueo
                                                                                <i class="input-helper"></i>
                                                                            </label>
                                                                            <div><small class="text-muted">Ver solicitudes de desbloqueo de clientes (solo lectura, sin crear/revisar/eliminar)</small></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="mt-3 mb-0 px-3 py-2 border alert alert-light">
                                                            ...
                                                            <div class="mb-3 pt-3 border-top">
                                                                <p class="mb-2 text-muted text-uppercase fw-bold small"
                                                                    style="letter-spacing: 0.5px;">
                                                                    <i class="me-1 mdi mdi-bullhorn"></i> Módulo Marketing
                                                                </p>
                                                                <div class="ms-1 row g-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-check form-check-success">
                                                                            <label class="form-check-label">
                                                                                <input type="checkbox"
                                                                                    name="puede_ver_marketing"
                                                                                    value="1"
                                                                                    class="form-check-input"
                                                                                    {{ old('puede_ver_marketing', $user->puede_ver_marketing ?? false) ? 'checked' : '' }}>
                                                                                Ver Marketing
                                                                                <i class="input-helper"></i>
                                                                            </label>
                                                                            <div><small class="text-muted">Dashboard de encuestas de satisfacción, sedes, consultores y metas</small></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="mt-3 mb-0 px-3 py-2 border alert alert-light">
                                                                    <small class="text-muted">
                                                                        <i class="me-1 mdi-information-outline mdi"></i>
                                                                        Los roles <strong>Marketing</strong> y <strong>Super Admin</strong> tienen acceso automáticamente.
                                                                        Usa este permiso para dar acceso a usuarios con otro rol.
                                                                    </small>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="mb-4 pt-4 border-top">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        @error('password')
                                                            <div class="mt-1 text-danger"><small>{{ $message }}</small>
                                                            </div>
                                                        @enderror
                                        ...
                                        <div class="card-body">
                                            ...
                                            @php
                                                ...
                                                $permisosTracking = collect([
                                                    'puede_ver_motorizados' => 'Tracking Motorizados',
                                                ])->filter(fn($label, $campo) => $user->$campo);

                                                $permisosRetiros = collect([
                                                    'puede_ver_retiros_ordenes' => 'Retiros de Órdenes',
                                                ])->filter(fn($label, $campo) => $user->$campo);
                                            @endphp
                                            ...
                                            @if ($permisosTracking->isNotEmpty())
                                                <div class="mb-3 pb-3 border-bottom">
                                                    <p class="mb-2 text-muted"><small><i
                                                                class="me-1 mdi mdi-map-marker-path"></i>Permisos
                                                            Tracking</small></p>
                                                    <div class="d-flex flex-wrap gap-1">
                                                        @foreach ($permisosTracking as $label)
                                            ...
                                            @if ($permisosRetiros->isNotEmpty())
                                                <div class="mb-3 pb-3 border-bottom">
                                                    <p class="mb-2 text-muted"><small><i
                                                                class="me-1 mdi mdi-clipboard-list-outline"></i>Permisos
                                                            Retiros</small></p>
                                                    <div class="d-flex flex-wrap gap-1">
                                                        @foreach ($permisosRetiros as $label)
