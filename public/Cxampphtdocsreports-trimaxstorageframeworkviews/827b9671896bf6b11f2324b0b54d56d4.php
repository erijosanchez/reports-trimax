...
<div
    <?php echo $attributes->merge(['class' => "flex flex-col gap-2.5 bg-neutral-50 dark:bg-white/1 border border-neutral-200 dark:border-neutral-800 rounded-xl p-2.5 shadow-xs"]); ?>

    x-data="{
        totalQueries: <?php echo min(count($queries), 100); ?>,
        currentPage: 1,
        perPage: 10,
        get totalPages() {
...
<?php endif; ?>
    ...
    <div class="flex flex-col gap-1">
        ...
        <div
            ...
            x-show="Math.floor(<?php echo $index; ?> / perPage) === (currentPage - 1)"
        >
...
<?php unset($__componentOriginal9e277ab5ada333d718192209049fcff4); ?>
<?php endif; ?>
                    <span class="text-neutral-500 dark:text-neutral-400"><?php echo $connectionName; ?></span>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.syntax-highlight','data' => ['code' => $sql,'language' => 'sql','truncate' => true,'class' => 'min-w-0','dataTippyContent' => ''.nl2br($sql).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['code' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($sql),'language' => 'sql','truncate' => true,'class' => 'min-w-0','data-tippy-content' => ''.nl2br($sql).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="text-neutral-500 dark:text-neutral-200 text-right flex-shrink-0"><?php echo $time; ?>ms</div>
        </div>
